...
SELECT
    ...
    165,
    'NOK',
    '1,766 NOK per child monthly (~ USD)',
    'standard'::public.payment_method,
    'guaranteed_recurrent',
    'direct_deposit',
    'state_federal',
...
SELECT
    ...
    230,
    'DKK',
    '~1,600 to 4,900 DKK per quarter (~ USD/mo average)',
    'standard'::public.payment_method,
    'guaranteed_recurrent',
    'direct_deposit',
    'state_federal',
...
SELECT
    ...
    140,
    'GBP',
    '£102.40 monthly for eldest child, £67.80 for additional children (~ USD/mo)',
    'standard'::public.payment_method,
    'guaranteed_recurrent',
    'direct_deposit',
    'state_federal',
...
SELECT
    ...
    1250,
    'NZD',
    'NZ+ weekly / NZ,000+ fortnightly (~,250 USD/mo single)',
    'standard'::public.payment_method,
    'guaranteed_recurrent',
    'direct_deposit',
    'state_federal',
...
SELECT
    ...
    120,
    'SEK',
    '1,250 SEK per child monthly (~ USD)',
    'standard'::public.payment_method,
    'guaranteed_recurrent',
    'direct_deposit',
    'state_federal',
...
SELECT
    ...
    160,
    'EUR',
    '€120 to €180 per child monthly (~ USD average)',
    'standard'::public.payment_method,
    'guaranteed_recurrent',
    'direct_deposit',
    'state_federal',
...
SELECT
    ...
    'Namibia''s Universal Old Age Grant provides an unconditional, non-means-tested monthly cash grant of N,400 to all Namibian citizens and permanent residents upon reaching age 60, constituting one of the few universal basic income pensions in Sub-Saharan Africa.',
    75,
    'NAD',
    'N,400 monthly (~ USD)',
    'standard'::public.payment_method,
...
SELECT
    ...
    100,
    'JPY',
    '¥10,000 to ¥15,000 per child monthly (~ USD)',
    'standard'::public.payment_method,
    'guaranteed_recurrent',
    'direct_deposit',
    'state_federal',
