...
SELECT
    ...
    'Spain''s Universal Child Benefit (Prestación por Crianza) provides a universal monthly cash grant of €200 (~ USD) for every child and youth under 18 years old. Designed as a foundational universal measure to eliminate child poverty and guarantee child subsistence unconditionally across all autonomous communities.',
    220,
    'EUR',
...
SELECT
    ...
    'China''s nationwide universal childcare cash subsidy provides families with 3,600 Yuan (~ USD) annually (~ USD/mo) for every infant and toddler from birth until age 3, disbursed completely independent of parental earnings or family income to support early childhood and address demographic shifts.',
    42,
    'CNY',
    '3,600 Yuan annually per child under 3 (~ USD/yr)',
    'standard'::public.payment_method,
    'guaranteed_recurrent',
    'direct_deposit',
    'state_federal',
    ...
    NULL,
    NULL,
    '25,000,000+ infants and toddlers',
...
SELECT
    ...
    1000,
    'DKK',
    '6,928 DKK monthly Grundbeløb basic pension (~,000 USD/mo)',
    'standard'::public.payment_method,
    'guaranteed_recurrent',
    'direct_deposit',
    'state_federal',
...
SELECT
    ...
    'Poland''s Family 800+ (formerly Rodzina 500+) provides an unconditional, non-means-tested monthly cash transfer of 800 PLN (~ USD) per child to all families residing in Poland for every child until they turn 18. Covers over 7 million children as a universal demogrant.',
    219,
    'PLN',
