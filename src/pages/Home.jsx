...
import { ArrowRight, Users, PlusCircle, Info, Sparkles, Globe } from "lucide-react";
        ...
        <section className="container mx-auto px-4 my-20">
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
              ...
              <Link to="/Programs">
                <Button variant="outline" className="border-green-600 text-green-700 hover:bg-green-50 cursor-pointer">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-green-100 text-center hover:-translate-y-1 transition-all duration-200">
              ...
              <Link to={createPageUrl("Programs")}>
                <Button variant="outline" className="w-full border-green-600 text-green-700 hover:bg-green-50 cursor-pointer">
                  Learn More
                </Button>
              </Link>
            </div>
